package com.devsu.msaccount.messaging;
...
/**
 * CLase que escucha los mensajes en la cola del topiko de kafka que corresponden a la respuesta del cliente sobre la informacion que se solicta para crear una cuenta
 */
@Service
public class AsyncConsumerService {
     ...
     * @throws Exception
     */
    @KafkaListener(topics = "client-response", groupId = "devsu")
